...
class DiscreteRiemannMetric {
    ...
    newton(target_K=null, dt=0.05, thresh=1e-4) {
        ...
        while (math.max(math.abs(DeltaK)) > thresh){
            let H = this.hessian();
            let deltau = Regression(H, DeltaK);
...
/*K = math.transpose(math.matrix([
  [-1.5707963267948966, -1.5707963267948966, -1.5707963267948966, -1.5707963267948966, -1.5707963267948966, 1.4137166941154069, 1.4137166941154069, 0.0, 0.0, 1.4137166941154069, 1.4137166941154069, 1.4137166941154069, 1.4137166941154069, 0.0, 0.0, 1.4137166941154069, 1.4137166941154069, 0.0, 0.0, 1.4137166941154069, 1.4137166941154069, 0.0, 0.0, 0.0, 0.0]
  ]));*/
